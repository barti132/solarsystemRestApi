package pl.bartoszsredzinski.solarsystemrestapi.bootstrap;
...
public class JpaBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public JpaBootstrap(PlanetService planetService) {
    ...
    private void loadPlanets() {
        ...
        mars.setDistanceFromSun(227936637l);
        mars.setName("Mars");
        mars.setMass("6.4171×10^23 kg");
        ...
        jupiter.setDistanceFromSun(778412027l);
        jupiter.setName("Jupiter");
        jupiter.setMass("1.8982×10^27 kg");
        planetService.save(jupiter);
        ...
        saturn.setDistanceFromSun(1426725413l);
        saturn.setName("Saturn");
        saturn.setMass("5.6834×10^26 kg");
        planetService.save(saturn);
